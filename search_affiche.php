					...
					<tr>
						<td height="257" align="center" valign="top" background="images/image_08.gif">
							<table width="600" height="257" border="0" bordercolor="#f0f" cellpadding="0" cellspacing="0"><!--表3,紫色线-->
								...
								<tr>
									<td height="249" align="center" valign="top"><table width="400"  border="0" bordercolor="#0f0" cellpadding="0" cellspacing="0"><!--表4，绿色线-->
										<tr>
											<td height="30" align="center" valign="top"><form name="form1" method="post" action="">查询关键字&nbsp;
												...
												if(isset($_POST["Submit"])){
													...
													$sql=mysql_query("select * from tb_affiche where title like '%".trim($keyword)."%' or content like '%".trim($keyword)."%' order by createtime desc ");
													//$sql中只包含了符合条件的公告内容
